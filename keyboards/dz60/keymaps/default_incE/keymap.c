...
KC_TAB,      KC_Q,      KC_W,     KC_E,      KC_R,      KC_T,       JP_LBRC,       KC_Y,      KC_U,           KC_I,          KC_O,         KC_P,            KC_BSPC,                KC_BSPC,\
KC_LCTL,      KC_A,      KC_S,      KC_D,      KC_F,      KC_G,     JP_RBRC,      KC_H,       KC_J,           KC_K,           KC_L,   KC_SCLN,                                          LT(2,KC_ENT),\
OSM(MOD_LSFT),      KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,         KC_RO,      KC_N,     KC_M, KC_COMM,     KC_DOT,    KC_SLSH,           KC_UP,                    LT(3,KC_UP),\
LGUI_T(KC_LALT),   KC_LALT, LT(1,KC_MHEN),     LT(1,KC_MHEN),       LT(1,KC_SPC),          KC_HENK,           KC_HENK,   KC_HENK,KC_HENK,     LT(2,KC_DEL),      LT(3,JP_AT)\
  ),
...
KC_LSFT,          KC_F1,         KC_F2,         KC_F3,       KC_F4,      KC_F5,    KC_JYEN,       KC_F6,       KC_F7,        KC_F8,        KC_F9,      KC_F10,    KC_TRNS,       LSFT(KC_INSERT),\
KC_LGUI,KC_TRNS,  KC_TRNS,             KC_NO,              KC_MINS,                  LSFT(KC_7),                         JP_PLUS, JP_PLUS ,   KC_MS_L,  KC_MS_D,   JP_AT\
  ),
...
KC_NO,    KC_NO,          KC_NO,                 KC_NO,              KC_HENK,               KC_NO,                             KC_NO,       KC_NO,     KC_NO,  KC_NO,           KC_NO\
  ),
